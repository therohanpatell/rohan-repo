...
class PipelineConfig:
    ...
    DQ_RESULTS_SCHEMA = StructType([  # Schema for DQ results table
        ...
        StructField("actual_result", StringType(), True),
        StructField("comparison_type", StringType(), False),
        StructField("validation_status", StringType(), False),
        StructField("impacted_downstream", ArrayType(StringType()), True),
        StructField("tags", ArrayType(StringType()), True),
        StructField("execution_timestamp", TimestampType(), False),
        StructField("error_message", StringType(), True),
        StructField("execution_duration", DoubleType(), True),
        StructField("run_dt", StringType(), False),
        StructField("partition_dt", StringType(), False)
    ])
    ...
    ERROR_CATEGORIES = {  # Standardized error types for classification
        ...
        'DQ_INVALID_COMPARISON_TYPE': 'Invalid comparison type specified',
        'DQ_EXPECTED_OUTPUT_FORMAT_ERROR': 'Expected output format invalid for comparison type',
